...
export class CommHandler extends DisposableDelegate implements Kernel.IComm {
   ...
   * **See also:** [[ICommMsg]]
   */
  send(data: JSONObject, metadata?: JSONObject, buffers: (ArrayBuffer | ArrayBufferView)[] = [], _disposeOnDone: boolean = true): Kernel.IShellFuture {
    if (this.isDisposed || this._kernel.isDisposed) {
  ...
  private _onClose: (msg: KernelMessage.ICommCloseMsg<'iopub'>) => void | PromiseLike<void>
